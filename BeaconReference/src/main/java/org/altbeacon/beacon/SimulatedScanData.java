...
public class SimulatedScanData {
	public static List<Beacon> iBeacons;
	/*
	...
	static {				
		iBeacons = new ArrayList<Beacon>();
		
		if (USE_SIMULATED_IBEACONS) {
			Beacon iBeacon1 = new Beacon("842af9c4-08f5-11e3-9282-f23c91aec05e",
					1, 1, -55, -55);
			Beacon iBeacon2 = new Beacon("842af9c4-08f5-11e3-9282-f23c91aec05e",
					1, 2, -55, -55);
